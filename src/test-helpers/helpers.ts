...
// Read this: https://dev.to/muratkeremozcan/-strengthening-pact-contract-testing-with-typescript-and-data-abstraction-16hc

/**
 * Converts and object with arbitraty value types to a `JsonMap` where all values are compatible with Pact's expectations.
